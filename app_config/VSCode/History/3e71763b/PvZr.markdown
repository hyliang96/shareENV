...
//因为\epsilon_\theta(x_t,t)估计的是z_t, 而z_t\sim N(0,I), 故\mathbb{E}_{x_t\sim q(x_t)}\Vert z_t\Vert^2 =\mathbb{E}_{x_0\sim q(x_0),z_t\sim N(0,I)}\Vert z_t\Vert^2 =\mathbb{E}_{z_t\sim n(0,I)} \Vert z_t\Vert^2 =1\\
\end{align}
$$