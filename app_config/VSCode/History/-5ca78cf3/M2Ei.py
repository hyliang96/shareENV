# Chen, Z., He, G., Zheng, K., Tan, X., & Zhu, J. (2023). Schrodinger Bridges Beat Diffusion Models on Text-to-Speech Synthesis (No. arXiv:2312.03491). arXiv. https://doi.org/10.48550/arXiv.2312.03491
...
class Diffusion_SB_Drift(BaseModule):
    ...
    # alpha_t =  int_0^t f(u) du = exp(f*t)
    # sigma^2_t = int_0^g g^2(u)/alpha^2_u du = g^2(1 - e^(-2f* t))/(2f)
