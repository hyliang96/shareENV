...
$$
F = \text{Tr}(\boldsymbol{\Sigma}_p^{1/2}\boldsymbol{O}\boldsymbol{R}) - \frac{1}{2}\text{Tr}(\boldsymbol{W_0}(\boldsymbol{O}^{\top}\boldsymbol{O} - \boldsymbol{I}))
$$
...
$$
\begin{aligned}
&\frac{\partial F}{\partial \boldsymbol{O}} = \boldsymbol{0} \quad \Rightarrow\quad \boldsymbol{R}\boldsymbol{\Sigma}_p^{1/2} = \frac{\boldsymbol{W_0}+\boldsymbol{W_0}^\top}{2}\boldsymbol{O}^{\top}\\
&\frac{\partial F}{\partial \boldsymbol{W}} = \boldsymbol{0} \quad \Rightarrow\quad \boldsymbol{O}^{\top}\boldsymbol{O} = \boldsymbol{I}\\
\end{aligned}
$$

令参数矩阵$\boldsymbol{W}=\dfrac{\boldsymbol{W_0}+\boldsymbol{W_0}^\top}{2}$，是对称的，于是我们有：
