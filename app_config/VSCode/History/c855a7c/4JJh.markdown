...
$$
\frac{\partial \text{Tr}\left( \boldsymbol{A} \boldsymbol{X} \boldsymbol{X}^\top \right)}{\partial \boldsymbol{X} }=\frac{\partial }{} =\boldsymbol{X}^\top (\boldsymbol{A}+\boldsymbol{A}^\top)
$$
