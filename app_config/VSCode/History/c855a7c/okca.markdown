...
\frac{\partial\, \text{Tr}\left( \boldsymbol{A} \boldsymbol{X}_2 \boldsymbol{X}^\top \right)}{\partial \boldsymbol{X}_2 }
=

\frac{\partial\, \text{Tr}\left( \boldsymbol{X_1} (\boldsymbol{X}^\top \boldsymbol{A})\right)}{\partial X_1}+
