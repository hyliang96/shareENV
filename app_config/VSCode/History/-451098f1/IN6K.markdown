...
[^diffusion-control]: Dai Pra, P. (1991). A stochastic control approach to reciprocal diffusion processes. Applied Mathematics and Optimization, 23(1), 313–329. https://doi.org/10.1007/BF01442404
...
参考4：[^sde]/Section 7.3 Girsanov Theorem

参考5：[^diffusion-control]
