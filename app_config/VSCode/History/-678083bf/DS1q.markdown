...
g^2(t)=a^2_{t|s}\frac{\dd }{\dd t}\frac{b_{t|s}^2}{a_{t|s}^2}=-2b_t^2\frac{\dd{\lambda_t}}{\dd t}\\
$$

$$
\log \frac{a_t}{b_t}=\lambda_t\\
\frac{b_t^2}{a_t^2}=e^{-2\lambda_t}\\
\frac{\dd}{\dd t}\frac{b_t^2}{a_t^2}=\frac{\dd}{\dd t}e^{-2\lambda_t}=-2 \frac{\dd \lambda_t}{\dd t} e^{-2\lambda_t}=-2 \frac{\dd \lambda_t}{\dd t}
$$
