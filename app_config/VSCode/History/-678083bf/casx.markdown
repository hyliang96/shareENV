...
g^2(t)=a^2_{t|s}\frac{\dd }{\dd t}\frac{b_{t|s}^2}{a_{t|s}^2}=-2b_{t|s}^2\frac{\dd{\lambda_{t|s}}}{\dd t}\\
$$
...
* 若已知$a_{t|s},b_{t|s}$，想反向求$f,g$：
  ...
  $$
  f(t)=\frac{\dd}{\dd t}\ln a_{t|s}\\
  g^2(t)=a^2_{t|s}\frac{\dd }{\dd t}\frac{b_{t|s}^2}{a_{t|s}^2}
  $$

  只需再证明
  $$
  a^2_{t|s}\frac{\dd }{\dd t}\frac{b_{t|s}^2}{a_{t|s}^2}=-2b_{t|s}^2\frac{\dd{\lambda_{t|s}}}{\dd t}
  $$
