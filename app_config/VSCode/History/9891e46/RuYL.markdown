...
\mathbb E^Q[\Phi_t^\alpha|A]=\int_A \Phi_t^\alpha\dd Q=\int _A \Phi_t^\alpha \frac{Z_t}{Z_s} \dd P=\mathbb E^P[\Phi_t^\alpha Z_t|A]\\
故 \mathbb E^Q[\Phi_t^\alpha|\mathcal F_s]=\mathbb E^P[\Phi_t^\alpha Z_ta|\mathcal F_s]=\Phi_s^\alpha Z_s
$$
