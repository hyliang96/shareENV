...
$\forall s<t, \forall A\in \mathcal F_t,\forall \alpha\in\R$，有

$$
\int_A \Phi_t^\alpha\dd Q=\int _A \Phi_t^\alpha Z_t \dd P\\
\mathbb E^Q[\Phi_s^\alpha|A]=\int_A \Phi_s^\alpha\dd Q=\int _A \Phi_s^\alpha Z_s \dd P=\mathbb [\Phi_s^\alpha Z_s|A]\\
故 \mathbb E^Q[\Phi_s^\alpha|\mathcal F_s]=\mathbb E^Q[\Phi_s^\alpha|\mathcal F_s]=\Phi_s^\alpha Z_s
$$
