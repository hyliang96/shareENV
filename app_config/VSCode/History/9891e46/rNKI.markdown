...
故 \mathbb E^Q[\Phi_t^\alpha|\mathcal F_s]=\frac{1}{Z_s}\mathbb E^P[\Phi_t^\alpha Z_ta|\mathcal F_s]\xlongequal{\Phi^\alpha\Z是P-局部鞅}\Phi_s^\alpha Z_s
$$

故$\Phi^\alpha=\exp\{\alpha Y^* -\frac 1 2\alpha ^2 [Y^*]^Q\}$是$Q$-局部鞅。
