...
x_t&=a_tx_0+b_tz_t\\
&将上两式带入下式\\
x_{\tau}&=\kappa_t x_t+\lambda_tx_0+\sigma_\tau z
\end{align}
$$
...
b_{\tau}^2=\sigma_\tau^2+\kappa_t^2 b^2
$$

两个方程，求解$\kappa_t,\lambda_t,\sigma_\t$三个变量，解有无穷个，可见$q(\boldsymbol x_{t-1}|\boldsymbol x_t,\boldsymbol x_0)$有很多种选择。故先将$\sigma_t$当作待定参数，去求余下两个变量。

$$
\kappa_t=\frac{\sqrt{b^2_{\tau}-\sigma_\tau^2}}{b_t}\\
...
$$
x_\tau=\kappa_t x_t+(a_\tau-a_t \kappa_t)x_0+\sigma_\tau z, z\sim N(0,I)\\
\kappa_t=\frac{\sqrt{b^2_{\tau}-\sigma_\tau^2}}{b_t} \label{ddim-repara}
$$
...
$$
\begin{align}
x_\tau &=\kappa_t x_t +(a_\tau-a_t\kappa_t)\frac{1}{a_t}(x_t-b_t\epsilon_\theta(x_t,t))+\sigma_\tau z_t\\
&=\frac{a_\tau}{a_t}x_t-(\frac{a_\tau}{a_t}b_t-b_t\kappa_t)\epsilon_\theta(x_t,t)+\sigma_\tau z\\
