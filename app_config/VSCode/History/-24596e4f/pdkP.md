...
x_t&=a_tx_0+b_tz_t\\
&将上两式带入下式\\
x_{\tau}&=\kappa_{t\tau} x_t+\lambda_tx_0+\sigma_\tau z
\end{align}
$$
...
$$
a_{\tau}=\kappa_{t\tau} a_t+\lambda_t \\
b_{\tau}^2=\sigma_\tau^2+\kappa_{t\tau}^2 b^2
$$

两个方程，求解$\kappa_{t\tau},\lambda_t,\sigma_\t$三个变量，解有无穷个，可见$q(\boldsymbol x_{t-1}|\boldsymbol x_t,\boldsymbol x_0)$有很多种选择。故先将$\sigma_t$当作待定参数，去求余下两个变量。

$$
\kappa_{t\tau}=\frac{\sqrt{b^2_{\tau}-\sigma_\tau^2}}{b_t}\\
\lambda_t=a_{\tau}-a_t\kappa_{t\tau}
$$
