...
记$\boldsymbol u=\frac{1}{2\boldsymbol q_t(\boldsymbol x_t)}\nabla\cdot\big(q_t(\boldsymbol x) \boldsymbol G(\boldsymbol x,t)\boldsymbol G^\top(\boldsymbol x,t) \big)$，则有$\tilde {\boldsymbol f}={\boldsymbol f}-\boldsymbol u-\boldsymbol v$,$q \nabla\cdot(\boldsymbol u+\boldsymbol v)=\frac{1}{2}\nabla\cdot\nabla\cdot(\boldsymbol G\boldsymbol G^\top q)$。
