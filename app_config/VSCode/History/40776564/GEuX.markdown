...
&=-\nabla\cdot\big[q\big(-\boldsymbol f+\frac{1}{2 q_t}\nabla\cdot(q_t \boldsymbol G\boldsymbol G^\top )\big)\big]\\
&=-\nabla\cdot\big[q\big(-\boldsymbol f+\frac{1}{ q_t}\nabla\cdot(q_t \boldsymbol G\boldsymbol G^\top )\big)-\nabla\cdot(q_t \boldsymbol G\boldsymbol G^\top )\big)\big]\\
&=-\nabla\cdot\big[q\big(-\boldsymbol f+\frac{1}{ q_t}\nabla\cdot(q_t \boldsymbol G\boldsymbol G^\top )\big)\big]
+\frac{1}{2}\nabla\cdot\nabla\cdot(q\boldsymbol G\boldsymbol G^\top )\\
&=-\nabla\cdot\big(q(-\bar{\boldsymbol f})\big)
+\frac{1}{2}\nabla\cdot\nabla\cdot(q\boldsymbol G\boldsymbol G^\top ),\\
&\quad 其中\bar {\boldsymbol f}:= \boldsymbol f-\frac{1}{ q_t}\nabla\cdot(q_t \boldsymbol G\boldsymbol G^\top )
\end{align}
$$
...
\Leftrightarrow \mathrm{d} \bar{x}(t)&=\epsilon_\theta\left(\frac{\bar{x}_t}{\sqrt{\varsigma^2(t)+1}}, t\right) \mathrm{d} \varsigma(t) \text { ，令 } \varsigma(t)=\sqrt{\frac{1-\bar{\alpha}_t}{\bar{\alpha}_t}}, \bar{x}(t)=\frac{x_t}{\sqrt{\bar{\alpha}_t}}
\end{align}
$$
