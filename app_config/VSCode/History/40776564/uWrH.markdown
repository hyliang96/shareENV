...
\tilde{\boldsymbol f}(\boldsymbol x_t,t):=\boldsymbol{f}(\boldsymbol x_t,t)
-\frac{1}{2}\nabla\cdot\big(\boldsymbol G(\boldsymbol x_t,t)\boldsymbol G^\top(\boldsymbol x_t,t)\big)
-\frac{1}{2} \nabla \log q_t(\boldsymbol x_t) \cdot \boldsymbol G(\boldsymbol x_t,t)\boldsymbol G^\top(\boldsymbol x_t,t)\label{ode}
$$
**逆向扩散SDE**为
$$
\dd{ \boldsymbol x_t }=\bar{\boldsymbol f}(\boldsymbol x_t,t)\dd t+\boldsymbol G(\boldsymbol x_t,t)\dd{\bar{\boldsymbol w}_t}\\
\bar{\boldsymbol f}(\boldsymbol x_t,t):=\boldsymbol{f}(\boldsymbol x_t,t)
-\nabla\cdot\big(\boldsymbol G(\boldsymbol x_t,t)\boldsymbol G^\top(\boldsymbol x_t,t)\big)
-\nabla \log q_t(\boldsymbol x_t)\cdot \boldsymbol G(\boldsymbol x_t,t)\boldsymbol G^\top(\boldsymbol x_t,t)\label{rev-sde}
$$
...
&=\boldsymbol f(\boldsymbol x,t)-\frac{1}{2\boldsymbol q_t(\boldsymbol x_t)}\nabla\cdot\big(q_t(\boldsymbol x) \cdot \big(\boldsymbol G(\boldsymbol x,t)\boldsymbol G^\top(\boldsymbol x,t) \big)
\end{align}
$$
...
$$
记$\boldsymbol u=\frac{1}{2}\nabla\cdot(\boldsymbol G\boldsymbol G^\top),\boldsymbol v=\frac{1}{2}\boldsymbol G\boldsymbol G^\top\nabla\log q$，则有$\tilde {\boldsymbol f}={\boldsymbol f}-\boldsymbol u-\boldsymbol v$,$q \nabla\cdot(\boldsymbol u+\boldsymbol v)=\frac{1}{2}\nabla\cdot\nabla\cdot(\boldsymbol G\boldsymbol G^\top q)$。

时间颠倒的ODE所对应的{\boldsymbol f}PK方程为
$$
