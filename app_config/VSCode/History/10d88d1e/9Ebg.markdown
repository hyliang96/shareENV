...
$$
\dd \boldsymbol x_t =f(t)\boldsymbol x_t\dd t+g(t)\dd w_t, w_t是标准布朗运动
$$

式中$\boldsymbol x_t, w_t\in\R^n, f,g:\R\mapsto \R$。
...
* 当$g(t)\not\equiv 0$，使用此性质，原前向SDE变为
  $$
  \begin{align}
  \dd \boldsymbol x_t &= \frac{\boldsymbol x_t}{a_t} (a_t f(t)\dd t)+g(t)\dd w_t\\
          &= \frac{\boldsymbol x_t}{a_t}\dd a_t +g(t)\dd w_t\\
  \frac{ \dd \boldsymbol x_t a_t - \boldsymbol x_t \dd a_t}{a_t^2}&=\frac{g(t)}{a_t}\dd w_t\\
  \dd \frac{\boldsymbol x_t}{a_t} &=\frac{g(t)}{a_t}\dd w_t\\
  \end{align}
  $$
  故通解为
  $$
