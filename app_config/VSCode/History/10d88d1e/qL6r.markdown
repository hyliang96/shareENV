...
**注：**
上述所有结论，可由从$x_0$求$x_t$，推广至从$x_s$求$x_t$。只需将$a_t,c_t$的积分下界由$0$变为$s$即可
...
* 当$g(t)\not\equiv 0$，使用此性质，原前向SDE变为
  ...
  故通解为
  $$
  \frac{\boldsymbol x_t}{a_t}-\frac{\boldsymbol x_0}{a_{s|s}}=c_t \boldsymbol z, \boldsymbol z\sim N(0,I),\\
