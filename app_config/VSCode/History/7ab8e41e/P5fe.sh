...
testtype='answers'
testfile='抖音很多刷国际歌的煽动情绪，评论下有很多人响应，他们又得不到好处，动机是什么？-2473764894'
...
for file in "${zhihu_html_dir}"/${testtype}/${testfile}.html; do
    ...
    perl -i -pe 'BEGIN{undef $/;} s|::: \{\.RichText-video za-detail-view-path-module="VideoItem".+?::: VideoCard-player|视频审核未通过|smg' "${file_out}"
