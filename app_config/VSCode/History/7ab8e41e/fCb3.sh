...
for file in "${zhihu_html_dir}"/pins/*.html; do
    ...
    perl -i -pe 'BEGIN{undef $/;} s|(\<a data-first-child="" target="_blank" href=")(.+?)(")|<>|smg' "${file_out}"
      <div class="RichText ztext PinItem-remainContentRichText">
        <div class="RichText ztext css-2ncmcq" options="[object Object]">
          <a data-first-child="" target="_blank" href="https://www.zhihu.com/zvideo/1385654193277952000?utm_source=ZHShareTargetIDMore" data-draft-node="block" data-draft-type="link-card" data-text="美国底层穷人的生活，努力工作却居无定所，看完颠覆你的认知" class="LinkCard new static" data-za-attach-info="" data-za-content-type="Zvideo">
            <span class="LinkCard-contents">
              <span class="LinkCard-title two-line">美国底层穷人的生活，努力工作却居无定所，看完颠覆你的认知</span>
              <span class="LinkCard-richText LinkCard-desc">
                <object>10 万播放 · 189 赞同 <a class="tag type_a">视频</a></object>
              </span>
            </span>
            <span class="LinkCard-image" style="height:60px">
              <img src="https://pica.zhimg.com/v2-55b564023d6400cfb3334feac47e5799_720w.jpg?source=7e7ef6e2" alt="点击可播放视频"/>
              <span class="LinkCard-image--video">
                <span style="display:inline-flex;align-items:center">​<svg width="10" height="10" viewbox="0 0 24 24" class="Zi Zi--Play" fill="currentColor"><path d="M18.2 10.96a1.2 1.2 0 010 2.08L6.8 19.62A1.2 1.2 0 015 18.58V5.419A1.2 1.2 0 016.8 4.38l11.4 6.582z"/></svg></span>
              </span>
            </span>
          </a>
        </div>
