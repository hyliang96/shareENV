...
(\<div class="RichText ztext PinItem-remainContentRichText"\>[\n ]*?\<div class="RichText ztext css-2ncmcq" options="\[object Object\]"\>[\n ]*?\<a data-first-child="" target="_blank" href="https://www.zhihu.com/zvideo/1385654193277952000?utm_source=ZHShareTargetIDMore".+?data-text="美国底层穷人的生活，努力工作却居无定所，看完颠覆你的认知".+?\>
