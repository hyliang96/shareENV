...
class Diffusion_SB_Beta(BaseModule):
    # dx = g^2(t) dw_t
    # f(t)=0
    # t    g^2(t)=beta_t=get_symmetric_noise(t,cumulative=False)
    # --------------
    # 0    beta_min
    # 0.5  beta_max
    # 1    beta_min
    ...
    # alpha_t=1
    # sigma_t=int_0^t beta_u du=get_symmetric_noise(t,cumulative=True)
    # sigma_1 = total_noise = (beta_min + beta_max) / 2
