    # get_beta 和 Vadim Popov, Ivan Vovk, Vladimir Gogoryan,DIFFUSION-BASED VOICE CONVERSION WITH FAST  MAXIMUM LIKELIHOOD SAMPLING SCHEME 的 式(7)一样
...
class Diffusion_Grad(BaseModule):
    ...
    # get_mu,get_nu,get_sigma 和 Vadim Popov, Ivan Vovk, Vladimir Gogoryan,DIFFUSION-BASED VOICE CONVERSION WITH FAST  MAXIMUM LIKELIHOOD SAMPLING SCHEME 的 式(9)一样
    def get_mu(self, s, t):
