# Generated by Powerlevel10k configuration wizard on 2022-01-19 at 17:22 CST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%244F%b'  # grey foreground
      local      clean='%244F%b'  # grey foreground
      local   modified='%244F%b'  # grey foreground
      local  untracked='%244F%b'  # grey foreground
      local conflicted='%244F%b'  # grey foreground
    fi
  ...
  ###########[ timewarrior: timewarrior tracking status (https://timewarrior.net/) ]############
  # Timewarrior color.
  typeset -g POWERLEVEL9K_TIMEWARRIOR_FOREGROUND=3
